...
const FirebaseIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      fill="#FFC24A"
    />
    <use fill="none" fillRule="evenodd" xlinkHref="#a" />
    <use fill="none" filter="url(#b)" xlinkHref="#a" />
    <path
      d="m135.005 150.38 32.955-33.75-32.965-62.93c-3.129-5.957-11.866-5.975-14.962 0L102.42 87.287v2.86l32.584 60.233Z"
      fill="#F4BD62"
    />
    <use fill="none" fillRule="evenodd" xlinkHref="#c" />
    <use fill="none" filter="url(#d)" xlinkHref="#c" />
    <path
      fill="#F6820C"
